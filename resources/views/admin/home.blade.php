                            ...
                            <div class="m-widget4">
                                ...
                                <div class="m-widget4__item">
                                    <div class="m-widget4__img m-widget4__img--logo">
                                        <img src="{{ url('') }}/dashboard/assets/app/media/img/client-logos/logo3.png" alt="">
                                    </div>
                                ...
                                <div class="m-widget4__item">
                                    <div class="m-widget4__img m-widget4__img--logo">
                                        <img src="{{ url('') }}/dashboard/assets/app/media/img/client-logos/logo1.png" alt="">
                                    </div>
                                    <div class="m-widget4__info">
													<span class="m-widget4__title">
														FlyThemes
                                ...
                                <div class="m-widget4__item">
                                    <div class="m-widget4__img m-widget4__img--logo">
                                        <img src="{{ url('') }}/dashboard/assets/app/media/img/client-logos/logo2.png" alt="">
                                    </div>
                                    <div class="m-widget4__info">
													<span class="m-widget4__title">
														AirApp
                        ...
                        <div class="m-portlet__body">
                            <div class="m-widget19">
                                <div class="m-widget19__pic m-portlet-fit--top m-portlet-fit--sides"
                                    ...
                                    <img src="{{ url('') }}/dashboard/assets/app/media/img/blog/blog1.jpg" alt="">
                                ...
                                <div class="m-widget19__content">
                                    <div class="m-widget19__header">
                                        <div class="m-widget19__user-img">
                                            <img class="m-widget19__img" src="{{ url('') }}/dashboard/assets/app/media/img/users/user1.jpg"
                                                 alt="">
                                        </div>
                        ...
                        <div class="m-portlet__body">
                            <div class="m-widget27 m-portlet-fit--sides">
                                <div class="m-widget27__pic">
                                    <img src="{{ url('') }}/dashboard/assets/app/media/img//bg/bg-4.jpg" alt="">
                        ...
                        <div class="m-portlet__body">
                            <div class="m-widget3">
                                <div class="m-widget3__item">
                                    <div class="m-widget3__header">
                                        <div class="m-widget3__user-img">
                                            <img class="m-widget3__img" src="{{ url('') }}/dashboard/assets/app/media/img/users/user1.jpg"
                                                 alt="">
                                        </div>
                                ...
                                <div class="m-widget3__item">
                                    <div class="m-widget3__header">
                                        <div class="m-widget3__user-img">
                                            <img class="m-widget3__img" src="{{ url('') }}/dashboard/assets/app/media/img/users/user4.jpg"
                                                 alt="">
                                        </div>
                                        <div class="m-widget3__info">
														<span class="m-widget3__username">
                                ...
                                <div class="m-widget3__item">
                                    <div class="m-widget3__header">
                                        <div class="m-widget3__user-img">
                                            <img class="m-widget3__img" src="{{ url('') }}/dashboard/assets/app/media/img/users/user5.jpg"
                                                 alt="">
                                        </div>
                                        <div class="m-widget3__info">
														<span class="m-widget3__username">
                                    ...
                                    <div class="m-timeline-2__items  m--padding-top-25 m--padding-bottom-30">
                                        ...
                                        <div class="m-timeline-2__item m--margin-top-30">
                                            ...
                                            <div class="m-list-pics m-list-pics--sm m--padding-left-20">
                                                <a href="#">
                                                    <img src="{{ url('') }}/dashboard/assets/app/media/img/users/100_4.jpg" title="">
                                                </a>
                                                <a href="#">
                                                    <img src="{{ url('') }}/dashboard/assets/app/media/img/users/100_13.jpg" title="">
                                                </a>
                                                <a href="#">
                                                    <img src="{{ url('') }}/dashboard/assets/app/media/img/users/100_11.jpg" title="">
                                                </a>
                                                <a href="#">
                                                    <img src="{{ url('') }}/dashboard/assets/app/media/img/users/100_14.jpg" title="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="m-timeline-2__item m--margin-top-30">
                                ...
                                <div class="tab-pane active" id="m_widget5_tab1_content" aria-expanded="true">
                                    ...
                                    <div class="m-widget5">
                                        <div class="m-widget5__item">
                                            <div class="m-widget5__pic">
                                                <img class="m-widget7__img"
                                                     src="{{ url('') }}/dashboard/assets/app/media/img//products/product6.jpg" alt="">
                                            </div>
                                        ...
                                        <div class="m-widget5__item">
                                            <div class="m-widget5__pic">
                                                <img class="m-widget7__img"
                                                     src="{{ url('') }}/dashboard/assets/app/media/img//products/product10.jpg" alt="">
                                            </div>
                                            <div class="m-widget5__content">
                                                <h4 class="m-widget5__title">
                                                    Branding Mockup
                                        ...
                                        <div class="m-widget5__item">
                                            <div class="m-widget5__pic">
                                                <img class="m-widget7__img"
                                                     src="{{ url('') }}/dashboard/assets/app/media/img//products/product11.jpg" alt="">
                                            </div>
                                            <div class="m-widget5__content">
                                                <h4 class="m-widget5__title">
                                                    Awesome Mobile App
                    ...
                    <div class="m-portlet m-portlet--bordered-semi m-portlet--full-height ">
                        ...
                        <div class="m-portlet__body">
                            <div class="m-widget4">
                                <div class="m-widget4__item">
                                    <div class="m-widget4__img m-widget4__img--logo">
                                        <img src="{{ url('') }}/dashboard/assets/app/media/img/client-logos/logo5.png" alt="">
                                    </div>
                                    <div class="m-widget4__info">
													<span class="m-widget4__title">
														Trump Themes
                                ...
                                <div class="m-widget4__item">
                                    <div class="m-widget4__img m-widget4__img--logo">
                                        <img src="{{ url('') }}/dashboard/assets/app/media/img/client-logos/logo4.png" alt="">
                                    </div>
                                    <div class="m-widget4__info">
													<span class="m-widget4__title">
														StarBucks
