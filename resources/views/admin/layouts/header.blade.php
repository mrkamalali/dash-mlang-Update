...
<head>
    ...
    @else
        <link rel="stylesheet" href="{{ url('dashboard') }}/dist/css/rtl/AdminLTE.min.css">
        <link rel="stylesheet" href="{{ url('dashboard') }}/dist/css/rtl/bootstrap-rtl.min.css">
        <link rel="stylesheet" href="{{ url('dashboard') }}/dist/css/rtl/rtl.css">
...
<!-- AdminLTE Skins. Choose a skin from the css/skins
    ...
    <!-- Morris chart -->
    <link rel="stylesheet" href="{{ url('dashboard') }}/bower_components/morris.js/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="{{ url('dashboard') }}/bower_components/jvectormap/jquery-jvectormap.css">
    <!-- Date Picker -->
    <link rel="stylesheet"
          href="{{ url('dashboard') }}/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{{ url('dashboard') }}/bower_components/bootstrap-daterangepicker/daterangepicker.css">
